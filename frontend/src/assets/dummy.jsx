...
import { User, Mail, Lock, Home, ListChecks, CheckCircle2, Home as HomeIcon, Flame} from 'lucide-react';
import { Edit2, Trash2, SortDesc, SortAsc, Award} from "lucide-react";
export const FIELDS = [
  {
    name: 'name',
    type: 'text',
...
// Common styles
export const Inputwrapper = 'flex items-center p-3 rounded-lg bg-gray-50 border border-purple-100 focus-within:border-purple-400 focus-within:ring-1 focus-within:ring-purple-200 transition';

export const BUTTONCLASSES = 'w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white font-medium shadow-md hover:shadow-lg transition disabled:opacity-60';

export const MESSAGE_SUCCESS = 'text-green-700 bg-green-50 border border-green-100 px-4 py-2 rounded-md text-sm mb-4';
export const MESSAGE_ERROR = 'text-red-700 bg-red-50 border border-red-100 px-4 py-2 rounded-md text-sm mb-4';

export const INPUTWRAPPER = 'flex items-center border border-purple-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500 transition-all duration-200';
export const BUTTON_CLASSES = 'w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2';
...
export const menuItems = [
    { text: "Dashboard", path: "/", icon: <HomeIcon className="w-5 h-5" /> },
...
// Filter Options (if needed for Dashboard)
...
// Empty State (optional if no tasks)
