...
import { HEADER, WRAPPER, ADD_BUTTON, STATS_GRID, STATS, ICON_WRAPPER, VALUE_CLASS ,STAT_CARD, LABEL_CLASS, FILTER_LABELS, FILTER_WRAPPER, SELECT_CLASSES, FILTER_OPTIONS, TABS_WRAPPER, TAB_BASE, TAB_ACTIVE, TAB_INACTIVE, EMPTY_STATE } from '../assets/dummy'
...
const Dashboard = () => {
    ...
    const stats = useMemo(() => ({
      total: tasks.length,
      // lowPriority: tasks.filter(t => priority?.toLowerCase() === 'low').length,
       lowPriority: tasks.filter(t => t.priority?.toLowerCase() === 'low').length,

      // mediumPriority: tasks.filter(t => priority?.toLowerCase() === ' medium').length,
      mediumPriority: tasks.filter(t => t.priority?.toLowerCase() === 'medium').length,

      // highPriority: tasks.filter(t => priority?.toLowerCase() === 'high').length,
