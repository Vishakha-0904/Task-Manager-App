...
import { DEFAULT_TASK, baseControlClasses, priorityStyles} from '../assets/dummy' // ✅ Correct import
import { Save, PlusCircle, X, AlignLeft, Calendar, Flag, CheckCircle } from 'lucide-react';
...
const [taskData, setTaskData] = useState(DEFAULT_TASK)
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        if(taskData.dueDate < today) {
            setError('Due date cannot in the past.');
            return;
        }
        setLoading(true)
        setError(null)
        ...
        <div className='bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate-fadeIn'>
            ...
            <div>
                ...
                <div className='flex items-center border border-purple-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500 transition-all duration-200'>
                    ...
                    onChange={handleChange} className='w-full focus:outline-none text-sm' placeholder='Enter task title'/>
            ...
            className='w-full bg-gradient-to-br from-fuchsia-500 to-purple-600 text-white font-medium py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 disabled:opacity-50 hover:shadow-md transition-all duration-200'>
