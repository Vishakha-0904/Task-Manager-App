...
import { BUTTON_CLASSES, INPUTWRAPPER, Inputwrapper } from '../assets/dummy'
...
const fields = [
  ...
  return (
    // <div className='max-w-md border-white bg-full shadow-lg border border-purple-100 rounded-xl p-8'>
    <div className='max-w-md w-full bg-white shadow-lg border border-purple-100 rounded-xl p-8'>


      {/* <ToastContainer position='top-centre' autoClose={3000} hideProgressBar/> */}
      ...
      <div className='mb-6 text-center'>
        ...
        <p className='text-gray-500 text-sm mt-1'>Sign in a continue to TaskFlow</p>
