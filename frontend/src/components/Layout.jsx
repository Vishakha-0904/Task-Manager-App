...
const Layout = ({onLogout,user}) => {
    ...
    try{
        ...
        const {data} = await axios.get("https://task-manager-app-vlcr.onrender.com/api/tasks/gp", {
    ...
    if(error) return(
        <div className='min-h-screen bg-gray-50 p-6 flex items-center justify-center'>
            ...
            <div className='bg-red-50 text-red-600 p-4 rounded-xl border border-red-100 max-w-md'>
                ...
                <button onClick={fetchTasks} className='mt-4 py-4 px-4 bg-red-100 text-red-700 rounded-lg text-sm font-medium hover:bg-red-200 transition-colors'>
            ...
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6'>
                ...
                <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
                    ...
                    <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border-purple-100'>
                        ...
                        <h3 className='text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800 flex items-centre gap-2'>
                            ...
                            <div className='relative pt-1'>
                                <div className='flex gap-1.5 items-center'>
                                    <div className='flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden'>
                                        ...
                                        <div className='h-full bg-gradient-to-r from-fuchsia-500 to-purple-600 tracking-all duration-500'
                    ...
                    <div className='bg-white rounded-xl p-4 sm:p-5 shadow:sm border border-purple-100'>
                        ...
                        <div className='space-y-2 sm:space-y-3'>
                            ...
                            {tasks.slice(0,3).map((task) => (
                                <div key={task._id || task.id} className='flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50/50 rounded-lg tracking-colors duration-200 border border-transparent hover:border-purple-100'>
                            ...
                            {tasks.length === 0 && (
                                <div className='text-center py-4 sm:py-6 px-2'>
                                    <div className='w-12 h-12 sm:w-16 sm:h-16 mx-auto sm:mb-4 rounded-full bg-purple-100 flex items-centre justify-centre'>
