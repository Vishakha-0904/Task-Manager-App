          ...
          <div className={TIP_CARD.container}>
            <div className='flex items-center gap-2'>
              ...
              <div>
                ...
                <a href="https://kalavati.net/" target='_blank' className='block mt-2 text-sm text-purple-500 hover:underline'>Visit Kalavati Technologies
                </a>
      ...
      {mobileOpen && (
        <div className='fixed inset-0 z-40'>
         ...
         <div className={SIDEBAR_CLASSES.mobileDrawerBackdrop} onClick={() => setMobileOpen(false)}/> 
          ...
          <div className='flex justify-between items-center mb-4 border border-b pb-2'>
